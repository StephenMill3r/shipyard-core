...
// src/dynamic-traits/limitbreak/utils/TransferPolicy.sol
...
// src/dynamic-traits/limitbreak/interfaces/IEOARegistry.sol

interface IEOARegistry is IERC165 {
    function isVerifiedEOA(address account) external view returns (bool);
}

// src/dynamic-traits/limitbreak/interfaces/ITransferSecurityRegistry.sol
...
// src/dynamic-traits/limitbreak/interfaces/ITransferValidator.sol
...
// src/dynamic-traits/limitbreak/access/OwnablePermissionsUpgradeable.sol

abstract contract OwnablePermissionsUpgradeable is ContextUpgradeable {
    function _requireCallerIsContractOwner() internal view virtual;
}

// src/dynamic-traits/limitbreak/utils/TransferValidationUpgradeable.sol
 ...
 */
abstract contract TransferValidationUpgradeable is ContextUpgradeable {
...
// src/dynamic-traits/limitbreak/interfaces/ICreatorTokenTransferValidator.sol

interface ICreatorTokenTransferValidator is ITransferSecurityRegistry, ITransferValidator, IEOARegistry {}

// src/dynamic-traits/limitbreak/interfaces/ICreatorToken.sol
...
// src/dynamic-traits/limitbreak/programmable-royalties/BasicRoyaltiesUpgradeable.sol
...
// src/dynamic-traits/limitbreak/utils/CreatorTokenBaseUpgradeable.sol
 ...
 *   creator token.</ul>
 */
abstract contract CreatorTokenBaseUpgradeable is OwnablePermissionsUpgradeable, TransferValidationUpgradeable, ICreatorToken {
     ...
     */
    function setToCustomValidatorAndSecurityPolicy(address validator, TransferSecurityLevels level, uint120 operatorWhitelistId, uint120 permittedContractReceiversAllowlistId) public {
        _requireCallerIsContractOwner();
        ...
        ICreatorTokenTransferValidator(validator).setPermittedContractReceiverAllowlistOfCollection(address(this), permittedContractReceiversAllowlistId);
    }
     ...
     */
    function setToCustomSecurityPolicy(TransferSecurityLevels level, uint120 operatorWhitelistId, uint120 permittedContractReceiversAllowlistId) public {
        _requireCallerIsContractOwner();
    ...
    function setTransferValidator(address transferValidator_) public {
        ...
        if (transferValidator_.code.length > 0) {
            try IERC165(transferValidator_).supportsInterface(type(ICreatorTokenTransferValidator).interfaceId) returns (bool supportsInterface) {
    ...
    function getSecurityPolicy() public view override returns (CollectionSecurityPolicy memory) {
        ...
        return CollectionSecurityPolicy({transferSecurityLevel: TransferSecurityLevels.Zero, operatorWhitelistId: 0, permittedContractReceiversId: 0});
    }
    ...
    function getWhitelistedOperators() public view override returns (address[] memory) {
        if (address(transferValidator) != address(0)) {
            return transferValidator.getWhitelistedOperators(transferValidator.getCollectionSecurityPolicy(address(this)).operatorWhitelistId);
        }
    ...
    function getPermittedContractReceivers() public view override returns (address[] memory) {
        if (address(transferValidator) != address(0)) {
            return transferValidator.getPermittedContractReceivers(transferValidator.getCollectionSecurityPolicy(address(this)).permittedContractReceiversId);
        }
    ...
    function isOperatorWhitelisted(address operator) public view override returns (bool) {
        if (address(transferValidator) != address(0)) {
            return transferValidator.isOperatorWhitelisted(transferValidator.getCollectionSecurityPolicy(address(this)).operatorWhitelistId, operator);
        }
    ...
    function isContractReceiverPermitted(address receiver) public view override returns (bool) {
        if (address(transferValidator) != address(0)) {
            return transferValidator.isContractReceiverPermitted(transferValidator.getCollectionSecurityPolicy(address(this)).permittedContractReceiversId, receiver);
        }
...
// src/dynamic-traits/limitbreak/erc721c/ERC721C.sol
...
// src/dynamic-traits/CryptoDadsOnchain.sol
